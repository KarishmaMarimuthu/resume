 ...
 **`Class/Course`** | **`Name of the Institution`** | **`Board of Study`** | **`Year of Passing`** | **`CGPA/Percentage`**
 --- | --- | --- | --- | --- 
 **B.Tech - IT** &ensp;&ensp;_(UG)_ | &ensp;&ensp;**Velammal College of Engineering &ensp;&ensp;&ensp;&ensp;&ensp;and Technology, Madurai** | &ensp;&ensp;*Anna University* | &ensp;&ensp;**`2020`** |  &ensp;&ensp;_**`8.81 (upto 6th semester)`**_ **_- [View][2]_**   
 **Higher &ensp;Secondary** &ensp;&ensp;_(HSC)_ | &ensp;&ensp;**Velammal Matriculation Higher &ensp;&ensp;&ensp;&ensp;&ensp;Secondary School, Madurai** | &ensp;&ensp;*State &ensp;&ensp;&ensp;&ensp;Board* | &ensp;&ensp;**`2016`** | &ensp;&ensp;***`93`*** - **_[View][3]_**
 **High School** &ensp;&ensp;_(SSLC)_ | &ensp;&ensp;**Velammal Matriculation Higher &ensp;&ensp;&ensp;&ensp;&ensp;Secondary School, Madurai** | &ensp;&ensp;*State &ensp;&ensp;&ensp;&ensp;Board* | &ensp;&ensp;**`2014`** | &ensp;&ensp;***`97.4`*** - **_[View][4]_**
---
...
### &emsp;&emsp;[**`LEADERSHIP`**](#internship) &emsp;&emsp; [**`TEAM PLAYER`**](#project-contest) &emsp;&emsp; [**`ADAPTIVE`**](#extra-curricular) &emsp;&emsp; [**`OPTIMISTIC`**](#extra-curricular)
...
&emsp;**Age &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;:&ensp;&ensp;_21 years_**
